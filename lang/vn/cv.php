...
return [
    ...
    'then press "SIGN IN AS GUEST" button' => 'sau đó nhấn vào nút "SIGN IN AS GUEST" sau đó nhấn
    nút "SIGN IN". Guests chỉ có thể thấy 5 cổ phiếu.',
    'Then visit the following links' => 'Sau đó truy cập vào những đường links bên dưới để thấy 5 bước tính toán:',
    'To fully analyze one stock I need from 1 to 4 weeks.' => 'Để phân tích hoàn toàn một cổ phiếu tôi cần từ 1 đến 4 tuần',
    ...
    của 1 VND ở năm 2030 là: 1*((100%-8.5%)^(2030-2022)) = 0.491 VND.',
    'I already built an algorithm' => 'Tôi đã xây dựng một thuật toán bên trong phần mềm để tính toán tất cả các bước cần thiết
    , rồi cộng tổng
    lợi nhuận của mỗi năm trong tương lai để tìm ra chỉ số PE cuối cùng.
    Sau đó lấy chỉ số PE cuối cùng đó nhân với EPS cơ sở đã chọn ở bước trên, tôi tính ra được giá trị nội tại của cổ phiếu.',
    'Step 6:' => 'Step 6: Sau đó nếu bạn thử truy cập',
    'home page' => 'trang chủ',
    'My software automatically summarizes' => 'Phần mềm đã tự động tổng hợp lại những dữ liệu quan trọng cho mỗi cổ phiếu,
     so sánh các cổ phiếu với nhau và trình bày một danh sách cổ phiếu được sắp xếp từ cổ phiếu rẻ nhất trước.',
    'My software still needs to improve' => 'Phần mềm hiện tại vẫn cần phải cải thiện rất nhiều nhưng hiện tại nó đã đạt được mục đích.',
    'Remote' => 'Từ xa',
    'Tally Group Australia' => 'Tally Group Australia mua lại Webtools Australia (UCONX team, 20 người)',
    'Multi-tenant app' => 'Multi-tenant app với kiến trúc microservice để cho những công ty năng lượng
    điện, ga thuê lại phần mềm,
    để quảng cáo và chốt sales trong một vài phút.',
    'Webtools New Zealand' => 'Webtools New Zealand (Agriculture team, 10 members)',
    'A monolith app' => 'A monolith app',
    'with both front-end and back-end' => 'với cả front-end và back-end tích hợp vào nhau để theo dõi gia súc 
    cho nông dân ở New Zealand.',
    'Texo Design' => 'Texo Design Ho Chi Minh (Team 20 người)',
    'An outsourcing company' => 'Công ty gia công phần mềm với đủ các loại sản phẩm công nghệ cho khách hàng
    bằng nhiều công nghệ khác nhau.',
    'A start-up tried to' => 'Start-up để thử xử lý tình trạng lộn xộn của thị trường bất động sản cho Việt Nam bằng cách copy',
    'and allowing users' => 'và cho phép người dùng đăng tin bất động sản miễn phí.',
    'Designed system, designed database' => 'Thiết kế hệ thống, thiết kế database, chọn công nghệ,
    thuê 3 lập trình viên khác, SEO, marketing, gọi vốn...',
    'The app reached 10,000 users' => 'Website đã đạt 10,000 người dùng sau 3 tháng, nhưng đối mặt với nhiều thử thách
    , và tôi không cảm thấy nó sẽ đi được xa nên tôi cho dừng lại.',
    'Real Estate Agent with main responsibility' => 'Môi giới bất động sản với công việc chính là tìm nhà/biệt thự/căn hộ
    cho người nước ngoài ở quanh khu vực Thảo Điền',
    'Civil Engineer at' => 'Kỹ sư xây dựng tại',
    'Masteri Thao Dien project' => 'dự án Masteri Thảo Điền.',
    'Jan' => '01',
    'Mar' => '03',
    'May' => '05',
    'Jun' => '06',
    ...
    'Nov' => '11',
    'Dec' => '12',
    'Real Estate Social Network. (Ho Chi Minh)' => 'Mạng xã hội cho bất động sản. (Hồ Chí Minh)',
];
